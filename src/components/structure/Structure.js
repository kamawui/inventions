...
const Structure = ({setPath}) => {
    ...
    return (
        <div className="structure-wrapper">
            <div className="main white border-white" style={{backgroundImage: "url('/img/structure.jpg')"}}>
            ...
            <div className="box structure4">
                <div className="box-container content-right white">
                    ...
                    <div className="box-content">
                        ...
                        <ul className="box-list">
                            <li>Відповідає за маршрутизацію пакетів даних між різними мережами. Визначає найефективніший шлях для передачі даних.</li>
                            <li>Забезпечує низьку затримку та високий рівень пропускної спроможності.</li>
                            <li>Сприяє співпраці різних мереж і з'єднанує різних провайдерів та регіональні мережамі.</li>
                        </ul>
                    </div>
                </div>
                <div className="box-container content-left white">
