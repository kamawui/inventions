                ...
                <div className="box-container content-right white">
                    ...
                    <div className="box-content">
                        ...
                        <ul className="box-list">
                            <li>У лютому 1958 року президент США Двайт Ейзенхауер наказав створити ARPA.</li>
                            <li>Каліфорнійський університет у Лос-Анджелес, Каліфорнійський університет у Санта-Барбарі, університет Юти, Стенфордський дослідницький центр стали базою для створення мережі ARPAnet. 29 жовтня 1969 році відбулося випробування мережі. 5 грудня 1969 року об’єднала ці 4 університети. У ARPAnetбули запроваджено протокол TCP/IP, який ми використовуємо і сьогодні.</li>
                            <li>ARPANET є першим військовим проектом для обміну інформацією.
                                Відомий своєю стійкістю до збоїв, ARPANET був основою для створення сучасного Інтернету.
                                Вже 1972 році був відправлений перший електронний лист, що выдзначило народження електронної пошти. Тоді почали використовувати знак @.</li>
                        </ul>
                    </div>
                </div>
